  ...
  head: () => ({
    meta: [
      { title: "Component Kit — Butler AI NEXUS" },
      {
        name: "description",
        content:
          "Every NEXUS UI primitive in one place: cards, chips, tiles, rows, skeletons and buttons.",
      },
    ...
    <div className="mx-auto flex min-h-dvh w-full max-w-lg flex-col bg-background sm:max-w-xl lg:max-w-2xl">
      ...
      <main className="flex-1 space-y-6 nexus-grid px-4 py-5">
        ...
        <section>
          ...
          <div className="space-y-2">
            ...
            <Row
              ...
              sub="status row"
              left={
                <IconBadge accent="ok" size={32}>
                  <Bot size={14} />
                </IconBadge>
              }
              right={<Chip accent="ok">ok</Chip>}
            />
          </div>
        </section>
        ...
        <section>
          ...
          <EmptyState
            title="nothing here"
            body="Empty states always say what would appear and why it is missing."
            icon={<Bot size={28} />}
          />
        </section>
        ...
        <section>
          ...
          <div className="grid grid-cols-2 gap-3">
            <div className="rounded-xl border border-dim bg-background p-4 text-center label-mono text-muted-foreground">
              bg
            </div>
            <div className="rounded-xl border border-dim bg-surface p-4 text-center label-mono text-muted-foreground">
              surface
            </div>
            <div className="rounded-xl border border-dim bg-surface-2 p-4 text-center label-mono text-muted-foreground">
              surface 2
            </div>
            <div className="rounded-xl border border-dim bg-surface-3 p-4 text-center label-mono text-muted-foreground">
              surface 3
            </div>
          </div>
        </section>
